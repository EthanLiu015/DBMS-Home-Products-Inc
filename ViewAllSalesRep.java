...
private void addSection(JPanel parent, String title, JPanel content) {
    ...
    addField(panel, "Sales Rep ID: ", String.valueOf(salesRep.getRepID()));
    addField(panel, "First Name: ", salesRep.getFirstName());
    addField(panel, "Last Name: ", salesRep.getLastName());
    addField(panel, "Title: ", salesRep.getTitle());
...
private JPanel createContactInfoPanel() {
    ...
    addField(panel, "Business Phone:", salesRep.getBusinessPhone());
    addField(panel, "Cell Phone:", salesRep.getCellPhone());
    addField(panel, "Home Phone:", salesRep.getHomePhone());
    addField(panel, "Fax Number:", salesRep.getFaxNumber());
    addField(panel, "Street:", salesRep.getStreet());
    addField(panel, "City:", salesRep.getCity());
    addField(panel, "State:", salesRep.getState());
    addField(panel, "Zip Code:", salesRep.getZipCode());
...
addField(panel, "Commission Rate:", String.format("%.1f%%", commissionPercentage));
    addField(panel, "Manager ID:", String.valueOf(salesRep.getManager()));
