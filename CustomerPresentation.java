...
public class CustomerPresentation {
    ...
    // Description Label
    JTextArea descriptionLabel = new JTextArea("Use this page to view, edit, or create customers.");
...
private JTable createCustomerTable() {
    ...
    table.getColumn("Actions").setCellEditor(new ButtonEditor(new JCheckBox(), mainApp, customers));
...
public void refreshCustomerTable() {
    ...
    ButtonEditor editor = (ButtonEditor) table.getColumnModel().getColumn(4).getCellEditor();
        editor.updateCustomers(customers);
}
...
class ButtonEditor extends DefaultCellEditor {
    ...
    public ButtonEditor(JCheckBox checkBox, MainApplication mainApp, List<Customer> customers) {
        super(checkBox);
        this.mainApp = mainApp;
    ...
    public Object getCellEditorValue() {
        if (isPushed) {
            ...
            Customer selectedCustomer = customers.get(row);
            mainApp.showCustomerDetails(selectedCustomer);
        }
        isPushed = false;
        return label;
    }
